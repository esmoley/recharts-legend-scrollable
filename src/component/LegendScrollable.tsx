...
import {
  DefaultLegendScrollableContent,
  Payload,
  Props as DefaultProps,
  ContentType,
} from './DefaultLegendScrollableContent'
...
function renderContent(content: ContentType, props: Props) {
  ...
  return <DefaultLegendScrollableContent {...otherProps} />
}
...
export class LegendScrollable extends PureComponent<Props, State> {
  ...
  private wrapperNode: HTMLDivElement | null = null
